Name = "Me"; NameChangable = true; ScriptContainer = 
{
	...
	"Raven .name. Happy to see a bookshelf! The red one high up looks interesting!",
	...
	"Raven looks at: the boxes, the bottle, the painting or the the lamp.", ---------- add touch system bottle 162, painting 170, lamp 181----------",
	...
	" ggg 146",
	"",
	"Their gaze catches the bottles on the floor. Raven raises an eyebrow slightly. Damn beer.",
