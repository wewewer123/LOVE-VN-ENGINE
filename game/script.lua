ScriptContainer = 
{
    ...
    "Will I ask her the question? qqq I can't get up the nerve to ask right now. With a gulp, I decide to ask her later.",
    "Ummm... Will you... ",
    "Will you be my artist for a visual novel?",
    "Silence.",
    "She looks so shocked that I begin to fear the worst. But then...",
    "Is a visual novel one of those digital books? qqq No, it's a kind of videogame you can play on your computer or a console.",
    "It is indeed like an book that you can read on a computer or a console, but it's also interactive.",
    "Interactive?",
    ...
    "",
    "",
    "No, it's a kind of videogame you can play on your computer or a console.",
